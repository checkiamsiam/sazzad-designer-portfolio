...
!(function (e, t) {
      ...
      (we = e || r()) &&
        ...
        (Pe = E.isTouch =
          Ce.matchMedia && Ce.matchMedia("(hover: none), (pointer: coarse)").matches
            ? 1
            : "ontouchstart" in Ce || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints
            ? 2
            : 0),
        (De = E.eventTypes =
          (
        ...
        if (!Re(e, 1)) {
          ...
          (se.x = t),
            ...
            (i || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) &&
              (h && (re = !0), i || (se.isDragging = !0), Ve(n, o), i || (d && d(se)));
        }
      }
      function Ye(t) {
        if (!Re(t, 1)) {
  ...
  function Bb() {
    (v && v.isPressed && !(v.startX > Ge.clientWidth)) ||
      (ze.cache++, v ? (w = w || requestAnimationFrame(j)) : j(), ht || W("scrollStart"), (ht = gt()));
  }
  function Cb() {
  ...
  function Db() {
    ze.cache++,
      nt ||
        ...
        (b && y === Je.innerWidth && !(Math.abs(Je.innerHeight - m) > 0.25 * Je.innerHeight)) ||
        c.restart(!0);
  }
  function Gb() {
  ...
  function Jb(e) {
    for (var t = 0; t < H.length; t += 5)
      (!e || (H[t + 4] && H[t + 4].query === e)) &&
        ((H[t].style.cssText = H[t + 1]), H[t].getBBox && H[t].setAttribute("transform", H[t + 2] || ""), (H[t + 3].uncache = 1));
  }
  function Kb(e, t) {
    var r;
  ...
  function cc(e, t, r, n, o, i, a, s, l, c, u, f, p) {
    ...
    if ((p && p.seek(0), Ma(e))) a && R(a, r, n, !0);
      ...
      (h = J(t) || Ge),
        ((b = Mt(h) || {}) && (b.left || b.top)) ||
          "none" !== eb(h).display ||
          ((x = h.style.display), (h.style.display = "block"), (b = Mt(h)), x ? (h.style.display = x) : h.style.removeProperty("display")),
        (m = ub(w[0], b[n.d])),
        (y = ub(w[1] || "0", r)),
    ...
    return (
      p && h && ((d = Mt(h)), p.seek(f), (g = Mt(h)), (p._caScrollDist = d[n.p] - g[n.p]), (e = (e / p._caScrollDist) * f)),
      p && p.seek(v),
      p ? e : Math.round(e)
    );
  }
    ...
    function Uj(e, t, r, n, o) {
      ...
      return (
        ...
        ((t.modifiers = s)[p] = function (e) {
          return (
            (e = Math.round(f())) !== c && e !== u && 3 < Math.abs(e - c) && 3 < Math.abs(e - u)
              ? (i.kill(), (Uj.tween = 0))
                ...
                if (ie && e && ht) ob(ScrollTrigger, "scrollEnd", Gb);
                  ...
                  for (
                    La(x) && (x = x(Te)),
                      ...
                      Ka(m) &&
                        !m.indexOf("+=") &&
                        (~m.indexOf(" ") ? (m = (Ka(x) ? x.split(" ")[0] : "") + m) : ((v = ub(m.substr(2), d)), (m = Ka(x) ? x : P + v), (y = oe))),
                  ...
                  if (
                    ...
                    (O += v),
                    (Te._pinPush = b),
                    A && v && (((r = {})[he.a] = "+=" + v), w && (r[he.p] = "-=" + Pe()), He.set([A, B], r)),
                    ie)
                  )
                    (r = eb(ie)),
                      (i = he === Ke),
                      ...
                      !h &&
                        1 < O &&
                        ((p = { style: (p = (me ? je.scrollingElement || qe : be).style), value: p["overflow" + he.a.toUpperCase()] })[
                          "overflow" + he.a.toUpperCase()
                        ] = "scroll"),
                      Yb(ie, N, r),
                      (F = _b(ie)),
                      (n = Mt(ie, !0)),
            ...
            (Te.update = function (e, t, r) {
              if (!pe || r || e) {
                var n,
                  ...
                  d = Te.progress;
                if (
                  (t && ((M = k), (k = pe ? Pe() : u), ue && ((_ = w), (w = C && !ve ? C.totalProgress() : p))),
                  ...
                  if (
                    ...
                    ve ||
                      (!q || nt || dt
                        ...
                        : (q._dp._time - q._start !== q._time && q.render(q._dp._time - q._start),
                          q.resetTo ? q.resetTo("totalProgress", p, C._tTime / C._tDur) : ((q.vars.totalProgress = p), q.invalidate().restart()))),
                    ie)
                  )
                    ...
                    a && !nt
                      ? (ve &&
                        ...
                        de &&
                          ...
                          (Oa(Te.callbackAnimation), q ? q.progress(1) : Oa(C, "reverse" === i ? 1 : !p, 1)))
                      : ve && Q && !nt && Q(Te);
                }
                if (x) {
  ...
  function kc(e) {
    ...
    if (!a._isScrollT || 2e3 < s - a._isScrollT) {
      for (
        ;
        i && i !== Ge && ((i.scrollHeight <= i.clientHeight && i.scrollWidth <= i.clientWidth) || (!te[(t = eb(i)).overflowY] && !te[t.overflowX]));
