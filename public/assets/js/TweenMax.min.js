    ...
    function (a, b, c) {
        ...
        f = function (a) {
          ...
          return function (a, j, k) {
            ...
            if (!v) {
              ...
              for (
                v = f[u] = [], l = g ? Math.min(t, u) * i - 0.5 : d % t, m = g ? (u * i) / t - 0.5 : (d / t) | 0, r = 0, s = 1 / 0, q = 0;
                u > q;
                q++
              )
                (n = (q % t) - l),
      ...
      (g.version = "2.1.2"),
        ...
        (l.render = function (a, b, d) {
            ...
            (a >= q - h && a >= 0
              ...
              ? ((p._totalTime = p._time = p._cycle = 0),
                ...
                a > -h
                  ...
                  : 0 > a &&
                    ((p._active = !1),
                    0 === u && (p._initted || !p.vars.lazy || d) && (v >= 0 && (d = !0), (p._rawPrevTime = n = !b || a || v === a ? a : h))),
                p._initted || (d = !0))
          ...
          p._onUpdate &&
            (0 > a && p._startAt && p._startTime && p._startAt.render(a, !0, d), b || ((p._totalTime !== s || f) && p._callback("onUpdate"))),
      ...
      function (a, b, c) {
        ...
        return (
          ...
          (s._parseTimeOrLabel = function (b, c, d, e) {
            ...
            if (
              ((f = "number" != typeof b || c ? (this.duration() > 99999999999 ? this.recent().endTime(!1) : this._duration) : 0),
              "string" == typeof c)
            )
          ...
          (k.render = function (a, b, c) {
            ...
            if ((q !== p._time && (a += p._time - q), a >= r - e && a >= 0))
              ...
              m &&
                ...
                m._startTime < s &&
                  ((p._time = p._rawPrevTime = a = m._startTime), (p._totalTime = a + p._cycle * (p._totalDuration + p._repeatDelay))));
            }
        ...
        m = function (a, b, c) {
          ...
          for (j = s.length; --j > -1; ) {
            for (m = s[j], p[m] = i = [], n = 0, l = a.length, k = 0; l > k; k++)
              (d =
                null == c ? a[k][m] : "string" == typeof (o = a[k][m]) && "=" === o.charAt(1) ? c[m] + Number(o.charAt(0) + o.substr(2)) : Number(o)),
              ...
              parser: function (a, b, f, g, h, i) {
                ...
                return (
                  ...
                  !q.autoRotate ||
                    ...
                    (q.autoRotate =
                      null != l.end.left ? [["left", "top", "rotation", j, !1]] : null != l.end.x ? [["x", "y", "rotation", j, !1]] : !1)),
                  q.autoRotate &&
      ...
      function (a, b) {
          ...
          ka = function (a, b) {
            ...
            return (
              "string" == typeof a &&
                ...
                (a =
                  (c ? a.substr(0, 2) : 0) +
                  window["inner" + ("vh" === a.substr(-2) ? "Height" : "Width")] * (parseFloat(c ? a.substr(2) : a) / 100)),
            ...
            return (
              ...
              null == a
                ...
                : ((e = 360),
                  ...
                  (i = "=" === a.charAt(1)),
                  (g =
                    (i ? parseInt(a.charAt(0) + "1", 10) * parseFloat(f[0].substr(2)) : parseFloat(f[0])) * (-1 === a.indexOf("rad") ? 1 : L) -
                    (i ? 0 : b)),
                  f.length &&
                    (d && (d[c] = b + g),
        ...
        var ra = function (a, b, c, d) {
          ...
          ta =
            ((S._setPluginRatio = function (a) {
              ...
              if (
                (g.autoRotate && (g.autoRotate.rotation = g.mod ? g.mod.call(this._tween, h.rotation, this.t, this._tween) : h.rotation),
                1 === a || 0 === a)
              )
        ...
        (j = ya.prototype),
          (j.parseComplex = function (a, b, c, d, e, f) {
            ...
            if (
              (this.multi &&
                (I.test(c) || I.test(b) ? ((h = b.replace(I, "|").split("|")), (i = c.replace(I, "|").split("|"))) : m && ((h = [b]), (i = [c]))),
              i)
            ) {
              for (j = i.length > h.length ? i.length : h.length, g = 0; j > g; g++)
                (b = h[g] = h[g] || this.dflt),
                  (c = i[g] = i[g] || this.dflt),
                  m &&
                    ((k = b.indexOf(m)), (l = c.indexOf(m)), k !== l && (-1 === l ? (h[g] = h[g].split(m).join("")) : -1 === k && (h[g] += " " + m)));
              (b = h.join(", ")), (c = i.join(", "));
            }
            ...
            if (
              (Da
                ...
                : a.currentStyle &&
                  ...
                  (d =
                    d && 4 === d.length
                      ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), j.x || 0, j.y || 0].join(",")
                      : "")),
          ...
          Ua =
            ...
            S.setTransformRatio =
              function (a) {
                ...
                if (
                  (O && ((P += O), (B += O)),
                  ((((1 === a || 0 === a) && "auto" === N && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime)) ||
                    !N) &&
                    !J &&
                    !M &&
                    !D &&
                ...
                (k = 1),
                  ...
                  (B = D * K),
                  B &&
                    ((r = Math.cos(B)), (s = Math.sin(B)), (i = -s), (l = o * -s), (e = c * s), (h = f * s), (k = r), (o *= r), (c *= r), (f *= r)),
                  (B = C * K),
                  B &&
                    ((r = Math.cos(B)),
                    (s = Math.sin(B)),
          ...
          za("border", {
            ...
            parser: function (a, b, c, d, f, g) {
              ...
              return (
                ...
                this.parseComplex(
                  a.style,
                  this.format(h + " " + aa(a, "borderTopStyle", e, !1, "solid") + " " + aa(a, "borderTopColor", e, !1, "#FEFEF2")),
                  i.join(" "),
                  f,
                  g
                )
            ...
            formatter: function (a) {
              var b = a.split(" ");
              return b[0] + " " + (b[1] || "solid") + " " + (a.match(qa) || ["#FEFEF2"])[0];
            },
          }),
        ...
        return (
          (g.cascadeTo = function (a, c, d) {
            ...
            for (
              a = i._targets || i.target, $a(a, k, m), i.render(c, !0, !0), $a(a, l), i.render(0, !0, !0), i._enabled(!0), e = m.length;
              --e > -1;
    ...
    F(),
      ...
      (i._enabled = function (a, b) {
        return (
          ...
          b !== !0 &&
            (a && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !a && this.timeline && this._timeline._remove(this, !0)),
          !1
        );
      }),
      ...
      (i.eventCallback = function (a, b, c, d) {
        if ("on" === (a || "").substr(0, 2)) {
          ...
          null == b
            ? delete e[a]
            : ((e[a] = b), (e[a + "Params"] = q(c) && -1 !== c.join("").indexOf("{self}") ? this._swapSelfInParams(c) : c), (e[a + "Scope"] = d)),
    ...
    var H = u(
        ...
        function (b, c, d) {
          ...
          if (
            ...
            (this._propLookup = {}), (this._siblings = aa(b, this, !1)), 1 === i && this._siblings.length > 1 && ca(b, this, null, 1, this._siblings);
    ...
    (i._init = function () {
      ...
      (i.render = function (a, b, c) {
        ...
        if (h._time !== i || c) {
          ...
          h._onUpdate &&
            (0 > a && h._startAt && a !== -1e-4 && h._startAt.render(a, !0, c), b || ((h._time !== i || d || c) && h._callback("onUpdate"))),
            e &&
              (!h._gc || c) &&
