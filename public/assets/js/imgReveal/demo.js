 ...
 */
{
  ...
  class HoverImgFx5 {
    ...
    hideImage() {
      ...
      this.tl = new TimelineMax({
        ...
        .add("begin")
        .add(
          new TweenMax([this.DOM.revealDeco, this.DOM.revealInner], 0.2, {
            ease: Expo.easeOut,
            opacity: 0,
            scale: 0.9,
          }),
  ...
  class HoverImgFx7 {
    ...
    showImage() {
      ...
      this.tl = new TimelineMax({
        ...
        .add(
          new TweenMax(this.DOM.revealDeco, 0.2, {
            ease: Quad.easeInOut,
            startAt: { scaleX: 0 },
            scaleX: 1,
            scaleY: 0.8,
        ...
        .add(
          new TweenMax(this.DOM.revealInner, 0.9, {
    ...
    hideImage() {
      ...
      this.tl = new TimelineMax({
        ...
        new TweenMax(this.DOM.revealInner, 0.13, {
          ease: Sine.easeOut,
          scale: 0.8,
          opacity: 0,
        })
  ...
  class HoverImgFx8 {
    ...
    showImage() {
      ...
      this.tl = new TimelineMax({
        ...
        .add(
          new TweenMax(this.DOM.revealImg, 1.3, {
            ease: Expo.easeOut,
            startAt: { scale: 1.4 },
            scale: 1,
          }),
  ...
  class HoverImgFx10 {
    ...
    showImage() {
      ...
      this.tl = new TimelineMax({
        ...
        .add("begin")
        .add(
          new TweenMax(this.DOM.revealDeco, 0.5, {
            ease: Expo.easeOut,
  ...
  class HoverImgFx13 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], 0.7, {
  ...
  class HoverImgFx15 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], i === this.totalImages - 1 ? 1.2 : 0.55, {
  ...
  class HoverImgFx16 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], i === this.totalImages - 1 ? 0.3 : 0.3, {
  ...
  class HoverImgFx17 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], i === this.totalImages - 1 ? 0.8 : 0.55, {
  ...
  class HoverImgFx18 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], i === this.totalImages - 1 ? 0.4 : 0.55, {
  ...
  class HoverImgFx20 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], 0.25, {
            ease: Quad.easeOut,
            startAt: { opacity: 1 },
            opacity: i === this.totalImages - 1 ? 1 : 0,
          }),
    ...
    animateLetters() {
      const setColor = (letter) =>
        TweenMax.set(letter, {
          color: ["#00211C", "#0ff", "#f0f"][parseInt(getRandomFloat(0, 3))],
  ...
  class HoverImgFx23 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(this.DOM.revealImgs[i], i === this.totalImages - 1 ? 0.8 : 0.5, {
            ease: i === this.totalImages - 1 ? Expo.easeOut : Quint.easeOut,
